        ...
        methods: {
            ...
            crearTorta(){
                ...
                this.tortaData = {
                    ...
                    datasets: [{
                        ...
                        data: [this._props.datos[16].statistics[43].positive_value, this._props.datos[16].statistics[43].negative_value]
                    }]
                }
            },
            ...
            crearGrafico() {
                ...
                for (let i = 0; i < this._props.datos.length-1; i++) {
                    ...
                    this.chartData.datasets[0].data.push( this._props.datos[i].statistics[40].positive_value) 
                    this.chartData.datasets[1].data.push( this._props.datos[i].statistics[40].negative_value)
                }
            }
        }
    };
